...
public class ContactCreationTests {
  ...
  public void testContactCreation() {
    initAddNewContact();
    fillContactForm(new ContactData("Alex", "Gorny", "Cool Woker", "Mr", "GE", "New Orleans", "444-555-6666", "cool@mail.com", "woker@mail.com", "www.homepage.com"));
  ...
  private void fillContactForm(ContactData contactData) {
    ...
    wd.findElement(By.name("homepage")).sendKeys(contactData.getUrlHomePage());
  }
